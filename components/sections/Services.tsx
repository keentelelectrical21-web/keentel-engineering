...
const services = [
  ...
  { short: 'Compliance', title: 'NERC Compliance Services', desc: 'FAC-008, PRC, TPL, and MOD testing and modeling, with experienced audit preparation and compliance support.', href: '/service/nerc-compliance', image: '/images/services/nerc-compliance/NERC Compliance Services.png', scope: 'MOD · PRC · FAC · TPL' },

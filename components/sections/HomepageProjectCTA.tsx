    ...
    <section className="bg-[#F4F6FA] px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-[#06103C] px-5 py-16 shadow-[0_24px_70px_rgba(6,16,60,0.16)] sm:px-10 sm:py-20 lg:px-16">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          <p className="mb-3 font-jost text-xs font-bold uppercase tracking-[0.18em] text-[#E44BB8]">Data Center Engineering</p>
          <h2 className="font-urbanist text-3xl font-black leading-tight text-white sm:text-4xl lg:text-5xl">Power System Engineering for Data Centers</h2>
          <p className="mx-auto mt-5 max-w-3xl font-jost text-base leading-relaxed text-white/70 sm:text-lg">Keentel helps organizations improve reliability, redundancy, and power-system performance through electrical infrastructure design, load-flow and capacity analysis, backup-power evaluation, and harmonic analysis for high-density computing loads.</p>

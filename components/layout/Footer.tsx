        ...
        <div className="relative mb-10 overflow-hidden rounded-3xl border border-white/10 bg-[linear-gradient(120deg,rgba(255,255,255,0.055),rgba(255,255,255,0.02))] shadow-[0_20px_55px_rgba(0,0,0,0.14)]">
          ...
          <div className="relative grid grid-cols-1 gap-px bg-white/10 min-[380px]:grid-cols-2 sm:grid-cols-3 xl:grid-cols-5">
            <div className="flex min-h-32 items-center justify-center bg-[#07113D] px-3 py-6 sm:min-h-40">
              <img src="/images/NSPE%20logo-vertical.png" alt="National Society of Professional Engineers" className="h-auto w-[150px] rounded bg-white object-contain" />
            </div>
            ...
            <a
                ...
                className="group col-span-1 flex min-h-32 items-center justify-center bg-[#07113D] px-3 py-6 transition hover:bg-[#0A174A] min-[380px]:col-span-2 min-[520px]:col-span-1 sm:min-h-40"
              >
                <img

      ...
      <main>
        ...
        <section className="relative min-h-[400px] flex items-end overflow-hidden">
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(6,16,60,0.92) 0%, rgba(11,26,91,0.85) 60%, rgba(91,42,134,0.80) 100%)' }} />
            <div className="absolute top-0 right-0 w-[600px] h-[600px] blur-3xl rounded-full opacity-15" style={{ background: 'radial-gradient(circle, #A8228A 0%, transparent 70%)' }} />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-14">
              ...
              <div className="lg:w-2/5">
                ...
                <h2 className="font-urbanist font-black text-4xl sm:text-5xl leading-[1.1] mb-5" style={{ color: '#06103C' }}>
                  Contact Our Engineering Team
                </h2>
                <p className="font-jost text-base leading-relaxed mb-8" style={{ color: '#6B7280' }}>
                ...
                <div className="space-y-3 mb-10">
                  <a href="tel:813-389-7871"
                    ...
                    <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(11,26,91,0.08)' }}>
                    ...
                    <div>
                      ...
                      <p className="font-urbanist font-bold text-base" style={{ color: '#06103C' }}>813-389-7871</p>
                    </div>
                  </a>
                  ...
                  <a href="mailto:contact@keentelengineering.com"
                    className="flex items-center gap-4 p-4 rounded-2xl transition-all hover:shadow-md"
                    style={{ background: '#fff', border: '1px solid #E6E8F0' }}>
                    <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(168,34,138,0.08)' }}>
                    ...
                    <div>
                      ...
                      <p className="font-urbanist font-bold text-base" style={{ color: '#06103C' }}>contact@keentelengineering.com</p>
                    </div>
                  </a>
                  ...
                  <a href="mailto:BD@keentelengineering.com"
                    className="flex items-center gap-4 p-4 rounded-2xl transition-all hover:shadow-md"
                    style={{ background: '#fff', border: '1px solid #E6E8F0' }}>
                    <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(91,42,134,0.08)' }}>
                    ...
                    <div>
                      ...
                      <p className="font-urbanist font-bold text-base" style={{ color: '#06103C' }}>BD@keentelengineering.com</p>
                    </div>
                  </a>
                  ...
                  <a href="https://calendly.com/keentel-engineering/15min" target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-4 p-4 rounded-2xl transition-all hover:shadow-md"
                    style={{ background: '#fff', border: '1px solid #E6E8F0' }}>
                    <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(199,46,158,0.08)' }}>
                    ...
                    <div>
                      ...
                      <p className="font-urbanist font-bold text-base" style={{ color: '#06103C' }}>Schedule a Consultation</p>
                    </div>
                  </a>
                </div>
              ...
              <div className="lg:w-3/5">
                {submitted ? (
                  <div className="rounded-3xl p-12 text-center h-full flex flex-col items-center justify-center" style={{ background: '#fff', border: '1px solid #E6E8F0' }}>
                    <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6" style={{ background: 'rgba(168,34,138,0.1)' }}>
                      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: '#A8228A' }}>
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <h3 className="font-urbanist font-black text-3xl mb-3" style={{ color: '#06103C' }}>Message Received</h3>
                    <p className="font-jost text-base mb-8" style={{ color: '#6B7280' }}>
                  ...
                  <form onSubmit={handleSubmit} className="rounded-3xl p-8 sm:p-10" style={{ background: '#fff', border: '1px solid #E6E8F0' }}>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <input required value={form.firstName} onChange={e => setForm({ ...form, firstName: e.target.value })}
                          ...
                          style={{ border: '1.5px solid #E6E8F0', color: '#06103C', background: '#F6F7FB' }}
                          placeholder="John" />
                      </div>
                      <div>
                        ...
                        <input value={form.lastName} onChange={e => setForm({ ...form, lastName: e.target.value })}
                          className="w-full px-4 py-3 rounded-xl text-sm font-jost focus:outline-none"
                          style={{ border: '1.5px solid #E6E8F0', color: '#06103C', background: '#F6F7FB' }}
                          placeholder="Smith" />
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <select value={form.service} onChange={e => setForm({ ...form, service: e.target.value })}
                        className="w-full px-4 py-3 rounded-xl text-sm font-jost focus:outline-none"
                        style={{ border: '1.5px solid #E6E8F0', color: form.service ? '#06103C' : '#9CA3AF', background: '#F6F7FB' }}>
                    ...
                    <div className="mb-6">
                      ...
                      <textarea value={form.message} onChange={e => setForm({ ...form, message: e.target.value })}
                        ...
                        className="w-full px-4 py-3 rounded-xl text-sm font-jost focus:outline-none resize-none"
                        style={{ border: '1.5px solid #E6E8F0', color: '#06103C', background: '#F6F7FB' }} />
                    </div>
                    ...
                    <button type="submit" disabled={loading}
                      className="w-full text-white font-semibold py-4 rounded-xl transition-all disabled:opacity-70 flex items-center justify-center gap-2 hover:-translate-y-0.5"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {offices.map((office, i) => (
                <div key={i} className="rounded-2xl p-6 hover:shadow-md transition-all" style={{ background: '#F6F7FB', border: '1px solid #E6E8F0' }}>
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-4" style={{ background: i === 0 ? '#06103C' : 'rgba(168,34,138,0.1)' }}>
                  ...
                  <p className="font-urbanist font-bold text-sm mb-0.5" style={{ color: '#06103C' }}>{office.address}</p>

...
function FaqAccordion() {
  ...
  const faqs: [string, string][] = [
    ['Why are electrical reliability studies important for mining operations?', 'Equipment downtime can result in major production losses.'],
    ['What is microgrid analysis?', 'It evaluates isolated power systems operating independently from the main grid.'],
    ['Why are motor starting studies important in oil and gas facilities?', 'Large motors can cause voltage dips during startup.'],
    ['What is hazardous area electrical design?', 'It ensures electrical equipment operates safely in explosive environments.'],
    ['What standards apply to these facilities?', 'NEC hazardous location codes, IEEE standards, and industry safety regulations.'],
  ];
...
export default function OilGasMiningPage() {
  return (
    <>
      <Header />
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-10 items-center w-full">
            <div>
              ...
              <p className="font-jost text-white/80 text-lg mb-8">
                Oil, gas, and mining operations often operate in remote locations where electrical reliability is critical for safe and continuous operations. These facilities rely on robust power systems to support drilling equipment, processing plants, pumps, and heavy industrial loads.
              </p>
              <Link
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-urbanist font-black text-3xl md:text-4xl mb-4">
              Power System Engineering for Extraction and Processing Facilities
            </h2>
            <p className="font-jost text-gray-600 mb-4">
              Oil, gas, and mining facilities require reliable power for critical equipment. Our services include:
            </p>
          </div>
          <div className="max-w-3xl mx-auto">
            ...
            <p className="font-jost text-gray-600 text-center">
              These studies ensure reliable operation of critical industrial equipment.
            </p>
          </div>
        </section>

        {/* RELIABILITY + SAFETY (dark section, two columns) */}
        <section className="py-20 px-6" style={{ background: '#06103C' }}>
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
            <div>
              <img src="/images/industries/oil-gas-mining/backup-batteries.webp" alt="Power system reliability for remote operations" className="w-full rounded-2xl mb-6" />
              <h3 className="font-urbanist font-bold text-2xl text-white mb-4">
                Power System Reliability for Remote Operations
              </h3>
              <p className="font-jost text-white/80 mb-4">
                Many energy extraction sites operate in isolated or weak grid environments. Keentel Engineering performs studies to evaluate:
              </p>
              <ul className="space-y-2">
                {['Microgrid operation', 'Generator stability', 'Power quality performance', 'Backup generation reliability'].map((item) => (
                  <li key={item} className="font-jost text-white/80 flex gap-2">
                    <span style={{ color: '#A8228A' }}>●</span>
                    {item}
                  </li>
                ))}
              </ul>
              <p className="font-jost text-white/80 mt-4">
                This ensures reliable operation even in remote environments.
              </p>
            </div>
            <div>
              <img src="/images/industries/oil-gas-mining/power-quality-harmonic.webp" alt="Electrical safety and hazardous location design" className="w-full rounded-2xl mb-6" />
              <h3 className="font-urbanist font-bold text-2xl text-white mb-4">
                Electrical Safety and Hazardous Location Design
              </h3>
              <p className="font-jost text-white/80 mb-4">
                Oil and gas facilities must comply with strict electrical safety requirements. Our engineers support:
              </p>
              <ul className="space-y-2">
                {['Hazardous area electrical design', 'Grounding system analysis', 'Protection system design', 'Arc flash hazard evaluation'].map((item) => (
                  <li key={item} className="font-jost text-white/80 flex gap-2">
                    <span style={{ color: '#A8228A' }}>●</span>
                    {item}
                  </li>
              ...
              <p className="font-jost text-white/80 mt-4">
                These services ensure compliance with NEC and international safety standards.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="font-jost text-gray-600 max-w-3xl mb-10">
              Keentel Engineering delivers advanced power system engineering solutions for utilities, renewable energy, and industrial infrastructure projects.
            </p>
        ...
        <section className="py-20 px-6" style={{ background: '#06103C' }}>
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="font-jost text-white/80 mb-4">
                Planning an oil, gas, or mining project? Keentel Engineering helps industrial facilities improve electrical reliability, safety, and power system performance.
              </p>
              <p className="font-jost text-white/80 mb-8">
                Our engineers support power system studies, grid interconnection, substation engineering, and industrial electrical infrastructure projects.
              </p>
            ...
            <div>
              <img src="/images/industries/oil-gas-mining/contact-techs.png" alt="Keentel engineers" className="w-full rounded-2xl" />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6" style={{ background: '#06103C' }}>
          <div className="max-w-3xl mx-auto text-center mb-10">
            <h2 className="font-urbanist font-black text-3xl md:text-4xl text-white">FAQ – Oil, Gas &amp; Mining</h2>
          </div>
          <FaqAccordion />
        </section>
        ...
        <section className="py-16 px-6 bg-white text-center">
          ...
          <p className="font-jost text-gray-600 mb-8 max-w-2xl mx-auto">
            Explore Keentel Engineering&apos;s latest insights on power system studies, protection engineering, and grid modeling.
          </p>
          <Link
            href="/blog"
            className="inline-block rounded-full px-8 py-4 font-jost font-semibold text-white"

      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-10 items-center w-full">
            <div>
              <h1 className="font-urbanist font-black text-3xl md:text-5xl text-white leading-tight mb-6">
                Power System Engineering for Data Centers
              </h1>
              <p className="font-jost text-white/80 text-lg mb-8">
                Data centers and commercial infrastructure require highly reliable electrical systems to support critical operations. Even brief power interruptions can result in significant financial losses and operational disruptions.
              </p>
              <Link
            ...
            <div className="hidden md:block">
              <img src="/images/industries/hub/data-center-electrical.png" alt="Data center power systems" className="w-full rounded-2xl" />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-urbanist font-black text-3xl md:text-4xl mb-4">
                Electrical Power System Design for Data Centers
              </h2>
              <p className="font-jost text-gray-600 mb-4">
                These data center power system engineering services include electrical infrastructure design, power system analysis, and reliability optimization.
              </p>
              <ul className="space-y-2 mb-4">
                {[
                  'Expert system design for high-density computing loads.',
                  'Advanced backup power systems with redundancy for fault tolerance.',
                  'Power quality analysis to address harmonic distortion.',
                  'Risk management and reliability assessments for critical infrastructure.',
                  'Cutting-edge technologies for energy efficiency and sustainability.',
                ].map((item) => (
                  <li key={item} className="font-jost text-gray-700 flex gap-2">
              ...
              <p className="font-jost text-gray-600">
                Keentel Engineering provides power infrastructure engineering for data centers, ensuring reliable and scalable electrical systems. Our engineers help design reliable electrical systems capable of supporting high-density computing loads and continuous operations.
              </p>
            </div>
            <div>
              <img src="/images/industries/data-center-electrical/server-racks.webp" alt="Modern data center with server racks" className="w-full rounded-2xl" />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6" style={{ background: '#06103C' }}>
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
            <div>
              <img src="/images/industries/data-center-electrical/transformer-substation.webp" alt="Electrical infrastructure for high-density loads" className="w-full rounded-2xl mb-6" />
              <h3 className="font-urbanist font-bold text-xl text-white mb-3">
                Electrical Infrastructure for High-Density Loads
              </h3>
              <p className="font-jost text-white/80 text-sm mb-3">
                Modern data centers require advanced power system engineering to support large electrical loads. Our engineering services include:
              </p>
              <ul className="space-y-2 mb-3">
                {['Load flow and capacity analysis', 'Electrical distribution system design', 'Backup power system design'].map((item) => (
                  <li key={item} className="font-jost text-white/80 text-sm flex gap-2">
                    <span style={{ color: '#A8228A' }}>●</span>
                    {item}
                  </li>
                ))}
              ...
              <p className="font-jost text-white/80 text-sm">
                These studies ensure reliable electrical infrastructure for critical facilities, aligned with substation design services.
              </p>
            </div>
            <div>
              <img src="/images/industries/data-center-electrical/relay-protection.jpg" alt="Backup power and redundancy analysis" className="w-full rounded-2xl mb-6" />
              <h3 className="font-urbanist font-bold text-xl text-white mb-3 text-center">
                Backup Power and Redundancy Analysis
              </h3>
              <p className="font-jost text-white/80 text-sm mb-3">
                Data centers rely on redundant power systems to maintain uptime. Keentel Engineering evaluates:
              </p>
              <ul className="space-y-2 mb-3">
                {['Generator backup systems', 'UPS system performance', 'Redundant power distribution paths'].map((item) => (
                  <li key={item} className="font-jost text-white/80 text-sm flex gap-2">
                    <span style={{ color: '#A8228A' }}>●</span>
                    {item}
                  </li>
              ...
              <p className="font-jost text-white/80 text-sm">
                This helps ensure continuous operation even during equipment failures.
              </p>
            </div>
            <div>
              <img src="/images/industries/data-center-electrical/blueprint-cnc.webp" alt="Power quality and harmonic analysis" className="w-full rounded-2xl mb-6" />
              <h3 className="font-urbanist font-bold text-xl text-white mb-3 text-center">
                Power Quality and Harmonic Analysis
              </h3>
              <p className="font-jost text-white/80 text-sm mb-3">
                High-density electronic equipment can introduce harmonics into electrical power system design for data centers. Our engineers evaluate:
              </p>
              <ul className="space-y-2 mb-3">
                {['Harmonic distortion levels', 'Neutral conductor loading', 'Transformer heating effects'].map((item) => (
                  <li key={item} className="font-jost text-white/80 text-sm flex gap-2">
                    <span style={{ color: '#A8228A' }}>●</span>
                    {item}
                  </li>
              ...
              <p className="font-jost text-white/80 text-sm">
                This ensures reliable and efficient power distribution.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="font-jost text-gray-600 max-w-3xl mb-10">
              Keentel Engineering provides mission-critical power system engineering solutions for data centers, commercial infrastructure, and high-density computing environments.
            </p>
        ...
        <section className="py-20 px-6" style={{ background: '#06103C' }}>
          <div className="max-w-6xl mx-auto">
            ...
            <p className="font-jost text-white/80 mb-4 max-w-3xl">
              Planning a data center project or upgrading critical electrical infrastructure? Keentel Engineering helps organizations improve reliability, redundancy, and power system performance.
            </p>
            <p className="font-jost text-white/80 mb-8 max-w-3xl">
              Our engineers support backup power systems, harmonic analysis, electrical infrastructure design, and mission-critical facility engineering.
            </p>
        ...
        <section className="py-20 px-6" style={{ background: '#06103C' }}>
          <div className="max-w-3xl mx-auto text-center mb-10">
            <h2 className="font-urbanist font-black text-3xl md:text-4xl text-white">Technical FAQs</h2>
          </div>
          <FaqAccordion />
        </section>
        ...
        <section className="py-16 px-6 bg-white text-center">
          ...
          <p className="font-jost text-gray-600 mb-8 max-w-2xl mx-auto">
            Explore Keentel Engineering&apos;s latest insights on power system studies, grid modeling, and reliability engineering.
          </p>
          <Link
            href="/blog"
            className="inline-block rounded-full px-8 py-4 font-jost font-semibold text-white"

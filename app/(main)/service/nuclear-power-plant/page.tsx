...
export default function NuclearPowerPlantPage() {
  ...
  return <>
    ...
    <main>
      ...
      <ServicePageBottomSection serviceName="Nuclear Power Plant Electrical Engineering" bottomTitle="Nuclear Electrical Systems Engineered for Safety and Reliability" bottomDescription="Our licensed engineers support nuclear generation facilities with analysis, design, modification, compliance, and lifecycle asset engineering." bottomFeatures={['Off-site and on-site power system studies','Protection coordination and equipment duty','AC and DC system engineering','Cable, raceway, and grounding design','Modification and configuration-control support','Testing, commissioning, and reliability assessments']} bottomImage="/images/services/power-system-studies/industry-utilities.jpg" />
    </main>
    <Footer />
  </>
}

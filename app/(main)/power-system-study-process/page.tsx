...
const relatedArticles = [
  ['Load Flow Studies in Electrical Power System', '/load-flow-studies-in-electrical-power-system'],
  ['US Grid Code Compliance, Wind Farms Ride-Through & Reactive Power', '/us-grid-code-compliance-wind-farms-ride-through-reactive-power'],
  ['Importance of Power System Studies', '/importance-of-power-system-studies'],
  ['Substation Design Power System Case Studies', '/substation-design-power-system-case-studies'],
  ['Review of Large City Metropolitan Area Power System Development Trends', '/review-of-large-city-metropolitan-area-power-system-development-trends'],
  ['Why Is Power System Analysis Important for BESS Owners', '/why-is-power-system-analysis-important-for-bess-owners'],
  ['Information Management for Inverter-Based Resources (IBRs)', '/information-management-for-inverter-based-resources-ibrs-a-technical-guide-for-power-system-operators'],
  ['Transmission Engineering Solutions – ComEd and PJM Territories', '/service/transmission-line-design'],
  ['Power Trends 2025 – New York Electric Grid', '/power-trends-2025-new-york-electric-grid'],
  ['Advancing Power System Design Practices with IEEE PES TR-126', '/advancing-power-system-design-practices-with-ieee-pes-tr-126'],
  ['Harmonic Studies Offshore Wind Power Systems', '/harmonic-studies-offshore-wind-power-systems'],
  ['Change Management Process in Power Systems', '/change-management-process-in-power-systems-a-vital-link-between-operations-and-planning'],
  ['Comprehensive Power System Analysis – Industrial Reliability & Safety', '/comprehensive-power-system-analysis-industrial-reliability-safety'],
  ['Energy Sector Integration and Its Impact on Modern Power Grids', '/service/utility-scale-renewable-energy'],
  ['Advanced Power System Modeling Guide', '/advanced-power-system-modeling-guide'],
  ['Why Is Utility Interconnection Critical for Renewable Power Plants', '/why-is-utility-interconnection-critical-for-renewable-power-plants'],
  ['Keentel Power Pulse – Engineering the Future of the Grid', '/newsletters/keentel-power-pulse-engineering-the-future-of-the-grid-april-2025'],
  ['Synchrophasor Technology for Power System Stability', '/service/power-system-studies'],
  ['How Renewable Power Plants Prevent Electrical Grid Failures', '/service/utility-scale-renewable-energy'],
  ['Ensuring Design Stability in Power System Projects', '/ensuring-design-stability-in-power-system-projects-best-practices-and-upcoming-nerc-reporting-deadlines'],
  ['FERC RM22-12-000 Order No. 901 Explained', '/service/nerc-compliance'],
  ['Electrical Systems in Nuclear Power Plants – Design & Compliance', '/service/nuclear-power-plant'],
]

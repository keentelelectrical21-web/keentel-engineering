...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [{ url: '/images/favicon/favicon.png?v=6', type: 'image/png' }],
    shortcut: [{ url: '/images/favicon/favicon.png?v=6', type: 'image/png' }],
    apple: [{ url: '/images/favicon/favicon.png?v=6', type: 'image/png', sizes: '180x180' }],
  },
  openGraph: {
    title: 'Keentel Engineering | Electrical Power Engineering',
